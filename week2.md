...
앞으로는 '어떻게 코드를 작성할 것인가'보다는 '무엇을 만들어야 하고, 어떤 구조로 설계해야 하는가'가 더욱 중요한 역량이 될 것이라고 생각됨. AI가 구현의 세부사항들을 대신 처리해주는 만큼, 개발자는 문제의 본질을 파악하고 최적의 해결책을 도출하는 능력, 그리고 시스템 전체를 조망하며 각 컴포넌트 간의 관계를 설계하는 능력이 더욱 중요해질 것임.

그래서 이번 캠프에서도 CS 지식과 전체적인 설계를 중시하는 미션을 제시하는 것 같음.
